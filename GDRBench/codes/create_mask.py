...
def create_mask(list_result = None):

    for item in list_result:
        imgpath = f'D:\\NCKH\\NCKH2024-2025\\Project\\Seg-set\\Original_Images\\{item}'
        img_save_path = f'D:\\NCKH\\NCKH2024-2025\\Project\\tmp_img\\{item}'
        mask_save_path = f'D:\\NCKH\\NCKH2024-2025\\Project\\tmp_mask\\{item}'
...
#     imgpath = ''"D:\\NCKH\\NCKH2024-2025\\Project\\DGDR\\data\\FundusDG\\images\\DEEPDR\\severe_npdr\\130_l1.jpg"''
#     img_save_path = '130_l1.jpg'
#     mask_save_path = '130_l1.jpg'
#     rimg, rmask = rb_and_resize(imgpath, img_save_path, mask_save_path)
#     print('done')
#     display(rimg)
#     display(rmask)
